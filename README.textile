...
@curl -L https://raw.githubusercontent.com/wnr/oh-my-zsh/master/tools/install.sh | sh@

h4. via @wget@:

@wget --no-check-certificate https://raw.githubusercontent.com/wnr/oh-my-zsh/master/tools/install.sh -O - | sh@
...
@git clone git://github.com/wnr/oh-my-zsh.git ~/.oh-my-zsh@
...
This project wouldn't exist without all of our awesome users and contributors: "view our growing list of contributors":https://github.com/wnr/oh-my-zsh/contributors

...
@wget --no-check-certificate https://github.com/mrWiener/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
=======
...
>>>>>>> eafd5f325208421b82a770e57441dd1063eb5745
...
1. Clone the repository
  ...
  @git clone git://github.com/mrWiener/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":https://wiki.github.com/mrWiener/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
...
<<<<<<< HEAD
We have enough themes for the time being. Please fork the project and add in there, you can let people know how to grab it from there. 
...
* "View our growing list of contributors":https://github.com/mrWiener/oh-my-zsh/contributors
